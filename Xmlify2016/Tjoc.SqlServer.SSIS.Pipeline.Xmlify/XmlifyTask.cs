...
namespace Tjoc.SqlServer.SSIS.Pipeline.Xmlify2016
{
    #region Directives
    ...
    using Tjoc.SqlServer.SSIS.Pipeline.Xmlify2016.HelperClasses;
    ...
    [DtsPipelineComponent(DisplayName = "Xmlify", Description = "Converts multiple columns into a single Xml column", 
        IconResource = "Tjoc.SqlServer.SSIS.Pipeline.Xmlify.XmlifyTask.ico",ComponentType = ComponentType.Transform)]
