...
namespace Tjoc.SqlServer.Dts.Pipeline.Xmlify.HelperClasses
{
    ...
    internal static class XMLIfyCustomPropites
    {
        ...
        /// <param name="propertyExpressionType"> Type of the property expression. </param>
        /// <param name="persistState"> State of the persist. </param>
        public static void CreateCustomProperty(IDTSCustomProperty100 property, string name, object defaultValue,
                                                string description,
        ...
        public static Dictionary<string, CustomProperty> CreateCustomPropertyList()
        {
            ...
            customPropertiesList.Add(NULLATTRIBUTENAME,
                                     new CustomProperty
                                         {
            ...
            customPropertiesList.Add(NAMEATTRIBUTENAME,
                                     new CustomProperty
                                         {
            ...
            customPropertiesList.Add(XMLNAMESPACE,
                                     new CustomProperty
                                         {
                                             Name = "XML Namespace",
